...
import { MdEdit, MdDelete, MdAssignmentAdd, MdUpdate, MdCancel, MdQuiz, MdDateRange } from "react-icons/md";
const QuizComponent: React.FC = () => {
  ...
  return (
    <Box>
          ...
          <Card key={quiz._id} variant="outlined" className="quiz-card">
            <CardContent>
              ...
              <Box sx={{ display: 'flex', width: '100%', gap: '16px', paddingTop: '10px' }}>
                ...
                <Button sx={styles.deleteButton} variant="contained" color="secondary" onClick={() => handleDeleteQuiz(quiz._id)}>
                  <MdDelete />
                </Button>
              </Box>
            </CardContent>
      ...
      <Button sx={styles.button} variant='contained' onClick={() => openModal()}>
        <FaPlus />
      </Button>
      ...
      <Modal open={confirmationModalOpen} onClose={() => setConfirmationModalOpen(false)}>
        <Box sx={styles.model}>
          ...
          <Box sx={{ display: 'flex', gap: '16px', paddingTop: '10px' }}>
            <Button variant="contained" sx={styles.deleteButton} color="error" onClick={confirmDelete}>
              Yes, Delete
            </Button>
