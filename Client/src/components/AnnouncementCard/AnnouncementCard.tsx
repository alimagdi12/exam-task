...
import { FaUpload } from "react-icons/fa"; // Example for Font Awesome
            ...
            >
              ...
              <CardContent sx={{ flex: 1, borderLeft: { sm: `2px solid #bcbcbc` }, padding: { xs: '0px !important', md: '0 16px !important' } }}>
                ...
                <Box sx={{ display: 'flex', marginTop: 1, gap: 1 }}>
                  ...
                  <Button sx={styles.deleteButton} variant="contained" color="secondary" onClick={() => openConfirmModal(announcement._id)}>
                    <MdDelete />
                  </Button>
                </Box>
              </CardContent>
